...
<head>
    ...
    <title>Menghitung bilangan Yang Habis Di Bagi 6 dan 9</title>
</head>
<?php

$numberValue = $_POST['bilangan'];
?>

<body>
    <div class="flex items-center bg-blue-800">
        <img src="./img/unisba.png" class="h-20 mr-3" style="margin-left: 50px;">
        <strong class="font-mono text-2xl font-bold pr-4 text-white">DERET BILANGAN NIM GENAP | PRAKTIKUM 3 </strong>
    </div>
    <div class="m-10 grid grid-cols-2 gap-x-6 gap-y-8  ">
        <div class="sm:col-span-1">
            <label for="username" class="block text-sm font-medium leading-6 text-gray-900 ">Masukkan Bilangan</label>
            <div class="mt-2 ">
                <form action="praktikum3.php
                " method="post">
                    <div class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md ">
                        <input type="number" step="0.1" name="bilangan" id="username" autocomplete="username" class="block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6" placeholder="bilangan">
                    </div>
